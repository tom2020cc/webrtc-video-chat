...
> 🟢 **宝塔面板用户**：请直接看 [宝塔面板部署指南.md](宝塔面板部署指南.md)，含反代 WebSocket、SSL、安全配置的完整步骤。
...
| 文档 | 内容 |
|------|------|
| [宝塔面板部署指南.md](宝塔面板部署指南.md) | 宝塔 + Nginx 多站点共存部署（推荐入门） |
| [真实域名部署指南.md](真实域名部署指南.md) | 通用域名部署、Let's Encrypt 证书、Nginx 配置 |
| [快速开始指南.md](快速开始指南.md) | 最快上手路径 |
| [本地测试指南.md](本地测试指南.md) | 局域网/本机测试方法 |
| [快速域名测试指南.md](快速域名测试指南.md) | 域名快速验证流程 |
| [新功能使用指南-完整版.md](新功能使用指南-完整版.md) | 全部功能的详细使用说明与关键实现点 |
| [免费AI字幕使用指南.md](免费AI字幕使用指南.md) / [AI字幕功能测试指南.md](AI字幕功能测试指南.md) | AI 字幕的配置与测试 |
| [图片功能使用指南.md](图片功能使用指南.md) | 图片消息功能 |
| [故障排除指南.md](故障排除指南.md) | 常见问题排查 |
| [设备指纹识别技术文档.md](设备指纹识别技术文档.md) | 设备指纹实现原理 |
| [项目部署总结.md](项目部署总结.md) | 部署要点汇总 |
